//wxSVGFileDC with one function implementation (DoDrawPolyPolygon) that does not exist in the wx contrib directory  --ms
...
class WXDLLIMPEXP_SVG wxSVGFileDC : public wxDC
{
    ...
    private:
		...
		void DoDrawPolyPolygon(int n, int count[], wxPoint points[], wxCoord xoffset, wxCoord yoffset,
int fill_style);
