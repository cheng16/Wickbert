...
void wxSVGFileDC::DoDrawPolyPolygon(int n, int count[], wxPoint points[], wxCoord xoffset, wxCoord yoffset,
int fillStyle)
{
	if (m_graphics_changed) NewGraphics ();
    wxString s, sTmp ;
    ...
    wxASSERT_MSG(!wxSVG_DEBUG, wxT("wxSVGFileDC::DoDrawPolyPolygon Call executed")) ;
}
