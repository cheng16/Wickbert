...
#  WXWIDGETS_RELEASE_LIBRARIES       = release wxWindows libraries (W32 only)
#  WXWIDGETS_DEBUG_LIBRARIES       = debug wxWindows libraries (W32 only)
...
IF( WIN32_STYLE_FIND )
    ...
    #
    # If we don't have both debug and release, use requested type for both
    #
    IF( NOT WX_DEBUGANDRELEASE )
        IF( WXWIDGETS_USE_DEBUG )
...
ELSE( WIN32_STYLE_FIND )
    ...
    #
    # Unix puts all the libs in the common WXWIDGETS_LIBRARIES var
    #
    SET( WXWIDGETS_RELEASE__LIBRARIES "" )
    SET( WXWIDGETS_DEBUG__LIBRARIES "" )
